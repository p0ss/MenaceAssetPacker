...
public static class BuildTargetExtensions
{
	public static bool IsStandalone(this BuildTarget target)
	{
		...
		{
			BuildTarget.StandaloneWinPlayer or
			BuildTarget.StandaloneWin64Player or
			BuildTarget.StandaloneLinux or
			BuildTarget.StandaloneLinux64 or
			BuildTarget.StandaloneLinuxUniversal or
			BuildTarget.StandaloneOSXIntel or
			BuildTarget.StandaloneOSXIntel64 or
			BuildTarget.StandaloneOSXPPC or
			BuildTarget.StandaloneOSXUniversal => true,
			_ => false,
		};
	}

	public static bool IsCompatible(this BuildTarget target, BuildTarget comp)
	{
